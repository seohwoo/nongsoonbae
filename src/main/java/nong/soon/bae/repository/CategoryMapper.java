...
public interface CategoryMapper {
	...
	public int adProductCnt(int cate1);
	public List<AllProductDTO> cateprodutList (HashMap<String, String> map);
	public List<AllProductDTO> adcateprodutList (HashMap<String, String> map);
	...
	public int adCntDetail(HashMap<String, String> map);
	public List<AllProductDTO> productlistdetail(HashMap<String, String> map);
	public List<AllProductDTO> adproductdetail(HashMap<String, String> map);
